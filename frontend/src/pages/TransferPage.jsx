...
const styles = `
  ...
  .vb-page {
    ...
    background:#080b10;
    background-image:
      radial-gradient(ellipse 70% 50% at 20% -5%,rgba(185,28,28,.10) 0%,transparent 65%),
  ...
  .vb-back-btn:hover { background:rgba(255,255,255,.08); color:#fff; }
  .vb-page-title {
    font-family:'Syne',sans-serif;
    font-size:20px; font-weight:800; color:#fff; letter-spacing:.04em;
  }
  .vb-page-title span { color:#dc2626; }
  ...
  .vb-toggle input:checked ~ .vb-toggle-track { background:#dc2626; border-color:#dc2626; }
  .vb-toggle-thumb {
  ...
  .vb-step-dot.done   { background:rgba(220,38,38,.4); }
  .vb-step-dot.active { background:#dc2626; width:32px; }
  ...
  .vb-field label {
    ...
    color:rgba(255,255,255,.3); padding-left:2px;
  }
  .vb-input {
    width:100%; background:rgba(255,255,255,.04); border:1px solid rgba(255,255,255,.08);
    border-radius:12px; padding:14px 16px;
    font-family:'DM Sans',sans-serif; font-size:14px; color:#fff; outline:none;
    transition:border-color .2s, background .2s; caret-color:#dc2626;
  }
  .vb-input::placeholder { color:rgba(255,255,255,.2); }
  .vb-input:hover  { border-color:rgba(255,255,255,.14); }
  .vb-input:focus  { border-color:rgba(220,38,38,.55); background:rgba(220,38,38,.04); }
  .vb-input-icon-wrap {
    position:relative;
  }
  ...
  .vb-recipient-hint {
    font-size:12px; font-weight:500; color:#f87171; padding-left:4px;
  ...
  .vb-amount-wrap:focus-within { border-color:rgba(220,38,38,.55); }
  .vb-amount-prefix {
    padding:0 16px;
  ...
  .vb-amount-input {
    ...
    color:#fff; caret-color:#dc2626; min-width:0;
  }
  .vb-amount-input::placeholder { color:rgba(255,255,255,.1); }
  .vb-amount-hint {
    font-size:12px; color:rgba(255,255,255,.3); padding-left:4px; margin-top:2px;
    animation:vb-fade-in .2s ease both;
  }
  ...
  .vb-chip:hover  { background:rgba(255,255,255,.07); color:#fff; border-color:rgba(255,255,255,.14); }
  ...
  .vb-contact-card:hover  { background:rgba(255,255,255,.06); border-color:rgba(220,38,38,.25); }
  ...
  .vb-contact-name { font-size:13px; font-weight:500; color:rgba(255,255,255,.8); line-height:1.3; }
  .vb-contact-acc  { font-size:11px; font-family:'DM Mono',monospace; color:rgba(255,255,255,.28); margin-top:2px; }
  ...
  .vb-confirm-row .label { color:rgba(255,255,255,.35); }
  .vb-confirm-row .value { color:rgba(255,255,255,.75); font-weight:500; text-align:right; }
  .vb-confirm-row .value.mono { font-family:'DM Mono',monospace; font-size:12px; }
  .vb-confirm-row .value.green { color:#4ade80; font-weight:600; }

  /* Disclaimer box */
  .vb-disclaimer {
    background:rgba(255,255,255,.02); border:1px solid rgba(255,255,255,.06);
    border-radius:12px; padding:14px 16px;
    font-size:12px; color:rgba(255,255,255,.28); line-height:1.7;
  }
  ...
  .vb-btn {
    ...
    color:#fff; background:linear-gradient(135deg,#dc2626 0%,#991b1b 100%);
  ...
  .vb-btn-ghost:hover  { background:rgba(255,255,255,.07); color:#fff; }
  ...
  .vb-success-sub { font-size:13px; color:rgba(255,255,255,.35); margin-bottom:28px; }
  .vb-success-receipt {
    background:rgba(255,255,255,.03); border:1px solid rgba(255,255,255,.08);
  ...
  .vb-total-label { font-size:11px; text-transform:uppercase; letter-spacing:.12em; color:rgba(255,255,255,.3); margin-bottom:4px; }
  .vb-total-amount {
  ...
  @media(min-width:768px) {
    .vb-voice-left { border-bottom:none; border-right:1px solid rgba(255,255,255,.06); }
  }
  ...
  .vb-mic-btn.active {
    background:#dc2626;
    box-shadow:0 0 32px rgba(220,38,38,.4);
  }
  ...
  .vb-wbar {
    width:3px; border-radius:99px; background:rgba(220,38,38,.7);
  }
  ...
  .vb-transcript p { font-size:14px; color:rgba(255,255,255,.3); font-style:italic; line-height:1.5; }
  .vb-transcript p.live { color:rgba(255,255,255,.8); font-style:normal; }
  .vb-tips {
    background:rgba(255,255,255,.02); border:1px solid rgba(255,255,255,.06);
    border-radius:12px; padding:16px;
  }
      ...
      <div className="vb-page">
        ...
        {!voiceEnabled && step < 4 && (
          <div className="vb-steps">
            ...
            <span style={{ fontSize:11, color:'rgba(255,255,255,.25)', marginLeft:6, letterSpacing:'.06em' }}>
            ...
            {step === 2 && (
              <div className="vb-two-col" style={{ animation:'vb-fade-up .35s ease both' }}>
                ...
                <div className="vb-card" style={{ display:'flex', flexDirection:'column', gap:20 }}>
                  ...
                  <div style={{ display:'flex', alignItems:'center', gap:14, paddingBottom:20, borderBottom:'1px solid rgba(255,255,255,.06)' }}>
                    <div className="vb-avatar-lg">{initials(recipientName)}</div>
                    <div>
                      <p style={{ fontSize:15, fontWeight:500, color:'rgba(255,255,255,.85)', marginBottom:4 }}>{recipientName}</p>
                      <p style={{ fontSize:12, fontFamily:'DM Mono,monospace', color:'rgba(255,255,255,.3)' }}>{accountNumber}</p>
                    </div>
                  </div>
              ...
              <div className="vb-two-col-even" style={{ animation:'vb-fade-up .35s ease both' }}>
                ...
                <div className="vb-card" style={{ display:'flex', flexDirection:'column', gap:20 }}>
                  ...
                  <div style={{ textAlign:'center', padding:'8px 0' }}>
                    <p style={{ fontSize:11, letterSpacing:'.12em', textTransform:'uppercase', color:'rgba(255,255,255,.25)', marginBottom:8 }}>Anda akan mentransfer</p>
                    <p style={{ fontFamily:'Syne,sans-serif', fontSize:34, fontWeight:800, color:'#fff' }}>
              ...
              <div style={{ animation:'vb-scale-in .5s cubic-bezier(.22,1,.36,1) both', maxWidth:480, margin:'0 auto', width:'100%' }}>
                <div className="vb-card" style={{ textAlign:'center' }}>
                  <div className="vb-success-icon">
                    <CheckCircle2 size={32} color="#4ade80" strokeWidth={1.75} />
                  </div>
            ...
            <div className="vb-voice-inner">
              ...
              <div className="vb-voice-left">
                <div className="vb-mic-wrap">
                  ...
                  >
                    <Mic size={30} color={isListening ? '#fff' : 'rgba(220,38,38,.8)'} strokeWidth={1.75} />
                  </button>
                </div>

                {isListening
                  ? <div className="vb-wave-row">{[1,2,3,4,5,6,7].map(i=><div key={i} className="vb-wbar"/>)}</div>
                  : <p style={{ fontSize:12, color:'rgba(255,255,255,.25)', marginTop:12, textAlign:'center' }}>
                      Ketuk untuk mulai
                    </p>
                }
              </div>
